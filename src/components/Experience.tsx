...
const EXPERIENCE = [
  { year: 'Sep 2026 — Present', position: 'Software Engineer', company: 'Clarivate' },
  { year: 'Apr 2026 — Sep 2026', position: 'Junior Frontend Developer', company: 'Tyllo' },
    ...
    <div className="pf-container">
      <div className="exp-layout">
        <div className="exp-aside">
          ...
          >
            Six roles across product engineering, client work, and teaching — each one sharpened a different edge.
          </motion.p>
        </div>
